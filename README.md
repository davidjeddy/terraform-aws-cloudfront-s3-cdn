...
> **➡️ https://codeberg.org/DavidJEddy/terraform-aws-cloudfront-s3-cdn**
>
> Please update your remotes:
> ```bash
> git remote set-url origin https://codeberg.org/DavidJEddy/terraform-aws-cloudfront-s3-cdn
> ```
